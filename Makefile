...
USE_NGINX_DEVEL_KIT=	yes
NGINX_LUA_MODULE_VERSION=	0.5.0rc17
GIT_LUA_MODULE_VERSION=	0-g3dfd00a
FETCH_ARGS=	-pRr
...
USE_NGINX_LUA=	yes
NGINX_OPENSSL=	yes
LUA_RESTY_REDIS_LIB_VERSION=	0.08
GIT_LUA_RESTY_REDIS_LIB_VERSION=0-gcfd6ed5
FETCH_ARGS=	-pRr
...
USE_NGINX_LUA=	yes
NGINX_OPENSSL=	yes
LUA_RESTY_STRING_LIB_VERSION=	0.05
GIT_LUA_RESTY_STRING_LIB_VERSION=	0-g794d5f1
FETCH_ARGS=	-pRr
